...
public class BrigitteRecipeParserTest {
    ...
    static {
        try {
            url = new URL("https://www.brigitte.de/rezepte/schoko-biskuit-mit-kirschen-und-stracciatella-sahne-10532366.html");
    ...
    public static void parseDocument() throws IOException {
        ...
        parser = new BrigitteRecipeParser();
    }

    @Test
    public void getTitle() {
        String title = parser.getTitle(doc);
        assertEquals("Schoko-Biskuit mit Kirschen und Stracciatella-Sahne", title);
    }
